    ...
    >
      {data.map((c, i) => (
        <motion.article
          ...
          className="group relative flex flex-col w-[300px] rounded-[20px] overflow-hidden border-2 border-green-400 transition-colors duration-300 cursor-pointer"
          style={{
        ...
        >
          ...
          <div className="relative z-10 flex-1 p-[10px] box-border">
            <img
              ...
              alt={c.title}
              loading="lazy"
              className="size-[276px] object-cover rounded-[10px]"
            />
          </div>
